(function() {
  ...
  app.controller('MainController', function() {
  	var self = this;
  	self.finalWords = {};
  	self.options = {nouns: '', verbs: '', verbings: '', adverbs: '', adjectives: ''};
  	...
  	function setFinalArray(){
  		...
  		for(var prop in self.options){
  			...
  			self.finalWords[prop] = self.options[prop].split(', ');
  			// console.log('IP:',initialInputs);
  			randomize(self.finalWords[prop]);
  		}
